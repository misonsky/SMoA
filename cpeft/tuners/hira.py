...
from cpeft.config import PeftConfig,PeftType
...
class HiRAModel(torch.nn.Module):
    ...
    def _find_and_replace(self, adapter_name):
        lora_config: HiRAConfig = self.peft_config[adapter_name]
...
def mark_only_lora_as_trainable(model: nn.Module, bias: str = "none", config: HiRAConfig = None) -> None:
...
class Linear(nn.Linear, HiRALayer):
    ...
    def __init__(
        ...
        HiRALayer.__init__(self, in_features=in_features, out_features=out_features)
