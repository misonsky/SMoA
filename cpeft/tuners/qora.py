...
class LoraLayer(BaseTunerLayer):
    ...
    def update_layer(self, adapter_name, r, lora_alpha, lora_dropout, init_lora_weights):
        ...
        if r > 0:
            ...
            self.lora_R.update(nn.ModuleDict({adapter_name: nn.Linear(r, r, bias=False)}))
    ...
    def reset_lora_parameters(self, adapter_name):
        if adapter_name in self.lora_A.keys():
            ...
            nn.init.zeros_(self.lora_R[adapter_name].weight)
...
class QoraModel(BaseTuner):
    ...
    **Attributes**:
    ...
    def _check_new_adapter_config(self, config: QoraConfig) -> None:
        """
...
class Linear(nn.Linear, LoraLayer):
    ...
    def forward(self, x: torch.Tensor):
        ...
        if self.disable_adapters:
            ...
            result += (
                self.lora_B[self.active_adapter](self.lora_R[self.active_adapter](
