...
task_map = {
    ...
    'meta_math': TASK_TYPE.META_MATH,
    'common_all': TASK_TYPE.BOOLQ,
    'gsm8k': TASK_TYPE.BOOLQ,
    'mmlu': TASK_TYPE.MMLU,
    'sst2':TASK_TYPE.SST2,
    'multirc':TASK_TYPE.MULTIRC,
    'cb':TASK_TYPE.CB,
    'wic':TASK_TYPE.WIC,
    'wsc':TASK_TYPE.WSC,
    'rte':TASK_TYPE.RTE,
...
### Instruction:\n{cinput}\n\n### Let's think step by step. Response: {target} 
"""
MMLU_TEMPLATE ="""
The following are multiple choice questions (with answers) about {cinput} \nAnswer: {target}
"""
...
def format_causal_input(batch, left_tokenizer, right_tokenizer, max_token_length, for_test=False,
    ...
    lm_input = right_tokenizer(bos_concat_input,
                               add_special_tokens=False,
                               return_tensors='pt',
                               padding='max_length',
                               truncation=True,
